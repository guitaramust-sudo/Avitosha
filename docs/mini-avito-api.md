...
Качество `listing.quality` полностью серверное: цена больше нуля, хотя бы одно фото URL и описание от 150 символов. Поля: `score`, `isEligible`, `missingFields`, `nextActionHint`.
