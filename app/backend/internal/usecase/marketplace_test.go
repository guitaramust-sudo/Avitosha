...
func TestEvaluateListingQuality(t *testing.T) {
	tests := []struct {
		...
		{name: "short description", listing: model.Listing{PriceKopecks: 100, Description: "short", Photos: []model.ListingPhoto{{URL: "https://example.test/photo.jpg"}}}, score: 2, missing: []string{"description"}},
	}
